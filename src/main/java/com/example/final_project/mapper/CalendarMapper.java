...
public interface CalendarMapper {
    ...
    @Select("select a.empno empno, b.dept_no deptno, on_work onwork, off_work offwork, on_off_work OnOffWork, attendance, tardy, unregistered, vacation, DATE_FORMAT(date, '%Y-%m-%d') date" +
